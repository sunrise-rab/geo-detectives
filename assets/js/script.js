...
/**
 * Increment correct scores.
 * @param {number} incrementedCorrect 
 */
 ...
 * @param {number} incrementWrong 
 */
 const incrementWrongScore = (incrementWrong) => {
  wrongScore += incrementWrong;
 ...
 */
const loadQuestion = async(difficulty) =>{
